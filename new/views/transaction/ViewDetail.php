                            ...
                            <form id="transactionForm">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="transactionId" value="TRX-2024-001" readonly>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="customerId" required>
                                            ...
                                            <option value="1">John Doe - 081234567890</option>
                                            <option value="2">Jane Smith - 081234567891</option>
                                            <option value="3">Robert Johnson - 081234567892</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="transactionNote" rows="3" placeholder="Additional notes..."></textarea>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <div id="addItemForm" class="border rounded p-3 mb-3" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="itemId" required>
                                            ...
                                            <option value="1">Shirt (Kemeja)</option>
                                            <option value="2">Pants (Celana)</option>
                                            <option value="3">Dress (Gaun)</option>
                                            <option value="4">Suit (Jas)</option>
                                            <option value="5">Skirt (Rok)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="customerPrice" placeholder="0" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
